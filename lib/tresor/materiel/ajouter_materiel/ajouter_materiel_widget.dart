...
import 'ajouter_materiel_model.dart';
export 'ajouter_materiel_model.dart';
...
class AjouterMaterielWidget extends StatefulWidget {
  const AjouterMaterielWidget({super.key});

  static String routeName = 'AjouterMateriel';
  static String routePath = '/ajouterMateriel';

  @override
  State<AjouterMaterielWidget> createState() => _AjouterMaterielWidgetState();
}

class _AjouterMaterielWidgetState extends State<AjouterMaterielWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AjouterMaterielModel());

    _model.textController1 ??= TextEditingController();
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.quantiteeTextController ??= TextEditingController();
    _model.quantiteeFocusNode ??= FocusNode();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                controller: _model.quantiteeTextController,
                                focusNode: _model.quantiteeFocusNode,
                                autofocus: false,
                                textInputAction: TextInputAction.next,
                                obscureText: false,
                                decoration: InputDecoration(
                                ...
                                validator: _model
                                    .quantiteeTextControllerValidator
                                    .asValidator(context),
                              ),
                            ].divide(SizedBox(height: 4.0)),
                          ),
                              ...
                              StreamBuilder<List<ExploitationsRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<ExploitationsRecord>
                                      dropDownExploitationsRecordList =
                                      snapshot.data!;
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    controller:
                                        _model.dropDownValueController2 ??=
                                            FormFieldController<String>(null),
                                    options: dropDownExploitationsRecordList
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Indiquer si ce matériel est en service',
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                          font: GoogleFonts.inter(
                ...
                FFButtonWidget(
                  onPressed: () async {
                    await MaterielsRecord.collection.doc().set({
                      ...createMaterielsRecordData(
                        type: _model.dropDownValue1,
                        nomMateriel: valueOrDefault<String>(
                          _model.textController1.text,
                          'non spécifié',
                        ),
                        valeurAchat: valueOrDefault<int>(
                          int.tryParse(_model.textController3.text),
                          0,
                        ),
                        dureeDeVie: valueOrDefault<int>(
                          int.tryParse(_model.textController4.text),
                          0,
                        ),
                        dateAcquisition: _model.datePicked,
                        exploitation: valueOrDefault<String>(
                          _model.dropDownValue2,
                          'non spécifié',
                        ),
                        valeurVenale: int.tryParse(_model.textController3.text),
                        active: _model.switchValue,
                        quantity:
                            int.tryParse(_model.quantiteeTextController.text),
                      ),
                      ...mapToFirestore(
                        {
                    ...
                    await showDialog(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          title: Text('Enregistrement d\'un nouveau matéiel'),
                          content: Text(valueOrDefault<String>(
                            'Votre nouvel  ${_model.dropDownValue1} baptisé ${_model.textController1.text} a été correctement ajouté à la base de données',
                            'Une erreur semble s\'être produite',
                          )),
                          actions: [
                            TextButton(
                              onPressed: () =>
