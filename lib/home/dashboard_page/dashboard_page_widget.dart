...
import '/components/bottom_sheet_to_widget.dart';
...
/// Create a mobile page named DashboardPage.
///
/// Purpose:
/// Main dashboard after login.
///
/// UI:
/// - AppBar "Tableau de bord DEMETER"
/// - Cards:
///    - Mes exploitations
///    - Mes parcelles
///    - Activités à venir
...
/// - Load data filtered by current user
...
class _DashboardPageWidgetState extends State<DashboardPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().CurrentExploitationId != null) {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Gérez vos exploitations et suivez vos activités agricoles',
                  ...
                  GridView(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed(ListeActivitesPageWidget.routeName);
                        },
                        child: Container(
                          width: double.infinity,
                          decoration: BoxDecoration(
                          ...
                          StreamBuilder<List<ActivitesRecord>>(
                            stream: queryActivitesRecord(
                              queryBuilder: (activitesRecord) => activitesRecord
                                  ...
                                  .orderBy('date_prevue', descending: true),
                              limit: 5,
                            ),
                            builder: (context, snapshot) {
                              ...
                              List<ActivitesRecord>
                                  listViewActivitesRecordList = snapshot.data!;
